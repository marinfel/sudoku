...
/**
 * @class IHM_Popup is a graphical object intem of a specific list (see IHM_PopupList)
 * The designe pattern Observer is used on this object
 * @author Marc-Antoine
 */
public class IHM_Popup extends GridPane {
    ...
    private IHM_PopupCloseRequestEvent ihm_PopupCloseRequestEvent;
    
    /**
     * @class IHM_Popup constructor
     * This constructor shouldn't be called by the user, the object is automaticcally created by the list (see IHM_PopupList)
     ...
     * @param delay is the showing delay, after this delay, the popup is removed from the list
     */
    public IHM_Popup(String title, int titleFontSize, String text, int textFontSize, int delay){
        ...
        ihm_PopupCloseRequestEvent = new IHM_PopupCloseRequestEvent(this);
    ...
    /**
     * Set the behavior of a user click event on the widget, basically it request to close the popup
    ...
    /**
     * This method fires the event to notify all listener that the pop-up wants itself to be removed 
     */
    ...
    /**
     * Method which decrease the showing time.
     * It's call at each timeout of the 1sec period timer
     */
    ...
    private class TimeoutTimerTask extends TimerTask{
        ...
        public void run() {
            ...
            Platform.runLater(new Runnable(){
                ...
                /**
                 * Method run when JavaFX allows a detached thread
