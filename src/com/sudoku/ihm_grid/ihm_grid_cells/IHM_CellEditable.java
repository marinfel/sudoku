 ...
 * @author Marc-Antoine
 */
public class IHM_CellEditable extends IHM_Cell {
     ...
     */
    public IHM_CellEditable(double width, double height, int addlesFontSize, int valueFontSize){
    ...
    /**
     * Override method of IHM_Cell used to set the main value
     *
     * <p>This method will check wether the value is correct or not
     * see boolean IHM_Cell.checkValue(int value)</p>
     *
     ...
     *
     * <p>It will add a new addle if there is enough room</p>
     *
     ...
     *
     * <p>Will check what thre user enter in the TextField and apply or not a correction on it</p>
     *
     ...
     *
     * <p>Delete the addle and pass the focus to the previous or to the next addle or to the add-button</p>
     *
